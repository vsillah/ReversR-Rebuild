...
const url = 'http://127.0.0.1:5196/?cadPreview=mark-dispenser-v1';
const out = 'docs/qa/cad-design-review-polish';
...
(async () => {
  ...
  try {
    for (const width of [1440, 768, 390, 320]) {
      ...
      await capture('input');
      await disclosure('cad-import-details', 'Import readiness does not certify');
    ...
    for (const width of [1440, 768, 390, 320]) {
      ...
      const page = await context.newPage(); await page.goto('http://127.0.0.1:5196');
