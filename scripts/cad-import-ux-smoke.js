  ...
  try {
    for (const width of [375, 768, 1440]) {
      ...
      for (const mode of ['import', 'scan', 'type', 'lucky']) {
        ...
        await page.getByTestId('cad-import-grid-preview').waitFor();
        await page.getByTestId('cad-import-viewfinder-controls').waitFor();
        await page.getByTestId('cad-import-viewfinder-dial').waitFor();
        await page.getByTestId('cad-import-viewfinder-zoom').waitFor();
        ...
        await page.getByTestId('cad-import-grid-preview').click();
