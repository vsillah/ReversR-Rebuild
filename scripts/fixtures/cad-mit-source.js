...
const metadata = Object.freeze({
  id: 'kantoku-mit-sample', source: 'authorized-mit-cache', path: 'mit-sample.bin', format: 'iges',
...
const cacheRoot = path.join(__dirname, '../../node_modules/.cache/reversr-cad-public');
module.exports = { metadata, cacheRoot };
