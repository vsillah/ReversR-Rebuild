...
import { developmentConfiguration, developmentPassword, developmentPasswordCohort, developmentRedirect } from './developmentAuth';
...
export const { auth, signIn, signOut, store, isAuthenticated } = convexAuth(configuration ? {
  providers: [developmentPassword(developmentPasswordCohort())],
